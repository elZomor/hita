...
const FIELD_ERROR_TRANSLATIONS: Record<string, string> = {
  ...
  venue: 'PERFORMER_PAGE.EXPERIENCE.ERRORS.VENUE_REQUIRED',
  festival_name: 'PERFORMER_PAGE.EXPERIENCE.ERRORS.FESTIVAL_NAME_MAX',
  producer: 'PERFORMER_PAGE.EXPERIENCE.ERRORS.PRODUCER_REQUIRED',
  duration: 'PERFORMER_PAGE.EXPERIENCE.ERRORS.DURATION_INVALID',
  year: 'PERFORMER_PAGE.EXPERIENCE.ERRORS.YEAR_INVALID',
  roles: 'PERFORMER_PAGE.EXPERIENCE.ERRORS.ROLES_REQUIRED',
  show_type: 'PERFORMER_PAGE.EXPERIENCE.ERRORS.SHOW_TYPE_REQUIRED',
};
