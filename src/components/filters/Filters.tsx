...
const specialties = [
    "Drama", "Comedy", "Action", "Theater", "Musical",
    "Voice Acting", "Period Drama", "Method Acting", "Dance"
];

const locations = [
    "London, UK", "Los Angeles, USA", "New York, USA",
    "Madrid, Spain", "Mumbai, India", "Berlin, Germany"
];
