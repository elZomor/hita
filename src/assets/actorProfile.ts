...
export const performer: Performer = {
    ...
    profilePicture: 'http://localhost:8005/media/test/01f37d07-93e9-4380-91b8-19fa64eb94e7.jpg',
    status: 'AVAILABLE',
    gender: 'M',
    grade: 'ONE',
    age: 30,
...
const gallery: Gallery[] = [{
    imagePath: 'http://localhost:8005/media/test/01f37d07-93e9-4380-91b8-19fa64eb94e7.jpg',
...
export const contactDetailsObject: ContactDetailsObject = {isLocked: false, data: contactDetailsList}
